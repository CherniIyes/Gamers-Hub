...
const HomePage = () => {
  ...
  useEffect(() => {
    ...
    const fetchFeaturedGames = async () => {
      ...
      const data = [
        { id: 1, title: 'Albion', description: 'Albion is a role-playing video game and features a number of gameplay elements typical of that genre. The player controls a party of up to six characters,', imageUrl: 'https://www.stillfront.com/en/wp-content/uploads/sites/2/2018/10/alb-online.jpg' },
